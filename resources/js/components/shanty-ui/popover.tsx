...
import { dialogPopupSizeClassName } from './dialogs/dialog';
            ...
            <BasePopover.Positioner sideOffset={8}>
                <BasePopover.Popup
                    className={cn(
                        ...
                        'bg-modal text-modal-foreground shadow-sm',
                        'data-ending-style:scale-90 data-ending-style:opacity-0',
                        'data-starting-style:scale-90 data-starting-style:opacity-0',
                        size && dialogPopupSizeClassName(size),
                    )}
                >
                    <BasePopover.Arrow className="data-[side=bottom]:-top-2 data-[side=left]:right-[-13px] data-[side=left]:rotate-90 data-[side=right]:left-[-13px] data-[side=right]:-rotate-90 data-[side=top]:-bottom-2 data-[side=top]:rotate-180">
                        <ArrowSvg />
                    </BasePopover.Arrow>
                    {children}
                </BasePopover.Popup>
