    ...
    return (
        <BaseScrollArea.Scrollbar
            ...
            className={cn(
                ...
                {
                    'm-2 w-1 before:left-1/2 before:h-full before:w-5 before:-translate-x-1/2': orientation === 'vertical',
                    'm-2 h-1 before:right-0 before:-bottom-2 before:left-0 before:h-5 before:w-full': orientation === 'horizontal',
                },
            )}
        >
